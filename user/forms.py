...
class ChangeNicknameForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # super(ChangeNicknameForm, self).__init__(*args, **kwargs)  # python2的写法
        super().__init__(*args, **kwargs)  # 使用这样的写法的目的是，把子类的参数传到父类里
    ...
    def clean_nickname_new(self):
        nickname_new = self.cleaned_data.get('nickname_new', '').strip()  # strip() 清除字符头尾的空格
        if nickname_new == '':
